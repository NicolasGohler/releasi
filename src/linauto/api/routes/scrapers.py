...
from linauto.db.models import ScraperCookie
from linauto.db.repository import Repository
from linauto.linkedin.login_session import (
    DISPLAY,
...
class ScraperSessionManager:
    ...
    def _start_websockify(self, token_file: str):
        ...
        log_fd = open("/tmp/linauto_websockify_scraper.log", "ab")
        proc = subprocess.Popen(
            [
                "websockify",
                "--web", novnc_dir,
    ...
    async def start_session(self, site: str, start_url: str) -> str:
        ...
        self._site = site
        self._temp_dir = tempfile.mkdtemp(prefix=f"linauto_scraper_{site}_")
